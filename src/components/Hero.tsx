...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div
        className="relative z-10 container mx-auto pt-24 pb-20 md:pt-0 md:pb-0"
      ...
      <button
        onClick={nextSlide}
        className="hidden md:flex absolute right-4 top-1/2 -translate-y-1/2 z-20 bg-white/30 hover:bg-white/50 rounded-full transition-all"
        style={{ padding: 'clamp(0.5rem, 1vw, 0.75rem)' }}
