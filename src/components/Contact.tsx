...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="section-default bg-transparent">
      <div className="container mx-auto px-4">
        ...
        {/* Grid: Why (left) + Form (right) */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto mt-8">
          {/* Left: Why text + desktop cards */}
          <div
          ...
          >
            <div className="space-y-4">
              <h2 className="text-2xl font-lato font-bold text-burgundy mb-2">
                Why Choose Satriano Marine?
              </h2>
              <p className="text-lg text-burgundy leading-relaxed">
                We provide free estimates with no obligation. Our team delivers unmatched customer
        ...
        {/* Mobile-only cards below form */}
        <div className="max-w-6xl mx-auto mt-8 lg:hidden">
          <ContactCards />
        </div>
      </div>
    </section>
