        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className={`transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="space-y-8">
              <div>
                <h3 className="text-2xl font-bold text-slate-900 mb-4">Why Choose Satriano Marine?</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">North Redington Beach, Florida</p>
                    <p className="text-sm text-slate-500 mt-1">Serving All of Pinellas County</p>
                  </div>
                </div>
              </div>
            </div>
