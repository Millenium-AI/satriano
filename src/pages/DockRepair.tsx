  ...
  return (
    <>
      ...
      <a
        ...
        <h1 className="text-4xl md:text-5xl font-montserrat font-bold text-burgundy mb-6">Dock Repair & Maintenance</h1>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-gold">
          <h2 className="text-2xl font-lato font-bold text-burgundy mb-4">Maintenance Plans</h2>
